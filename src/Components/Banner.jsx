...
const Banner = () => {
    return (
        <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-5 p-2">
            <div className="md:w-1/2 space-y-4" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1000">
            ...
            <div className="md:w-1/2 rounded-lg shadow-2xl" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="1000">
